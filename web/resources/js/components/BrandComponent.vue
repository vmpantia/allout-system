        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <span class="page-title">List of Brand</span>
...
export default {
    ...
    methods: {
        ...
        searchBtn(value) {
            ...
            axios.get('brand/search/' + searchValue).then(response => {
                this.data_table = [];
        ...
        saveBtn() {
            ...
            if(this.values.brandID) {
                obj.functionID = '02C00';
                obj.brandID = this.values.brandID;
                obj.createdDate = this.values.createdDate;
                obj.modifiedDate = this.values.modifiedDate;
            }

            axios.post('brand/store', obj).then(response => {
        ...
        editBtn(props) {
            this.isUpdate = true;
            this.values = [];
            axios.get('brand/edit/' + props.row.brandID).then(response => {
                if(response.status === 200) {
        ...
        deleteBtn(props) {
            axios.get('brand/delete/' + props.row.brandID).then(response => {
