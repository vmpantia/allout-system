...
namespace AllOut.Desktop.Views.CategoryForms
{
    public partial class CategoryListForm : Form
    {
        ...
        {
            PopulateCategories(txtSearch.Text);
        }
        ...
        private void tblObjectList_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            else if (e.ColumnIndex == CHECKBOX_COL_IDX)
            {
                ...
                EnableOtherControls(_categoryIDs.Count > 0);
            }
        }
        ...
        private void PopulateCategories(string query = null)
        {
            ...
            var categories = (List<Category>)response.Data;
        ...
        private void PopulateTable(List<Category> categories)
        {
